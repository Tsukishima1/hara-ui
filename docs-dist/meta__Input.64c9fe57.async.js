!(function () {
  ...
  var V = (a, r, e) =>
    ...
    T = (a, r) => {
      ...
      if (_) for (var e of _(r)) Z.call(r, e) && V(a, e, r[e]);
      return a;
    },
    z = (a, r) => se(a, ue(r));
  var U = (a, r) => {
