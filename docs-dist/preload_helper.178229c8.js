      ...
      i = (function (t, e, n) {
        ...
        n,
        {
          ...
          f: [
            ...
            [
              'dumi__tmp-production__dumi__theme__ContextWrapper.14cc69f3.async.js',
              923,
            ],
          ...
          r: {
            '/*': [2, 3, 13, 5, 6, 10],
            '/': [11, 3, 13, 5, 6, 10],
            '/guide': [12, 3, 13, 5, 6, 10],
            '/~demos/:id': [0, 1, 4, 5, 6, 10],
            '/components/button': [7, 3, 13, 5, 6, 10],
            '/components/input': [8, 3, 13, 5, 6, 10],
            '/components/tooltip': [9, 3, 13, 5, 6, 10],
          },
        },
        { publicPath: '/' },
      );
