!(function () {
  ...
  var $ = (a, r, e) =>
    ...
    _ = (a, r) => {
      ...
      if (M) for (var e of M(r)) Z.call(r, e) && $(a, e, r[e]);
      return a;
    },
    z = (a, r) => se(a, ue(r));
  var w = (a, r) => {
    ...
    if (a != null && M)
      for (var n of M(a)) r.indexOf(n) < 0 && Z.call(a, n) && (e[n] = a[n]);
    return e;
  };
  (self.webpackChunkhara_ui = self.webpackChunkhara_ui || []).push([
    [210],
    {
      21456: function (a, r, e) {
        'use strict';
        var n;
        e.r(r),
          e.d(r, {
      ...
      73505: function (a, r, e) {
        ...
        const G = (0, n.forwardRef)((T, S) => {
          ...
          return (0, n.createElement)(
            ...
            [
              ...v.map(([E, O]) => (0, n.createElement)(E, O)),
              ...(Array.isArray(u) ? u : [u]),
            ],
          );
        });
        const K = (i, t) => {
          const l = (0, n.forwardRef)((v, u) => {
            ...
            return (0, n.createElement)(
              G,
              _({ ref: u, iconNode: t, className: A(`lucide-${R(i)}`, o) }, c),
            );
          });
          ...
          J = function (t) {
            ...
            return (
              (0, n.useEffect)(function () {
                var b = function (W) {
                  v.current && !v.current.contains(W.target) && x(!1);
                };
                return (
...
`,
          ...
          { value: '\u5C5E\u6027', paraId: 3, tocIndex: 6 },
          { value: '\u7C7B\u578B', paraId: 3, tocIndex: 6 },
          { value: '\u5FC5\u9009', paraId: 3, tocIndex: 6 },
          { value: '\u9ED8\u8BA4\u503C', paraId: 3, tocIndex: 6 },
          { value: '\u63CF\u8FF0', paraId: 3, tocIndex: 6 },
          { value: 'content', paraId: 3, tocIndex: 6 },
          { value: 'string', paraId: 3, tocIndex: 6 },
          { value: '\u662F', paraId: 3, tocIndex: 6 },
          { value: '-', paraId: 3, tocIndex: 6 },
          { value: '\u6587\u5B57\u5185\u5BB9', paraId: 3, tocIndex: 6 },
          { value: 'placement', paraId: 3, tocIndex: 6 },
          { value: 'string', paraId: 3, tocIndex: 6 },
          { value: '\u5426', paraId: 3, tocIndex: 6 },
          {
            value: '"top" | "bottom" | "left" | "right"',
            paraId: 3,
            tocIndex: 6,
          },
          { value: '\u663E\u793A\u4F4D\u7F6E', paraId: 3, tocIndex: 6 },
        ];
      },
      20289: function (a, r) {
        'use strict';
        r.Z = `import { Button, Tooltip } from 'hara-ui';
