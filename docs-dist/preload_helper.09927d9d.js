      ...
      i = (function (t, e, n) {
        ...
        n,
        {
          ...
          f: [
            ...
            ['Select__index.md.1a179d2b.async.js', 259],
            [
              'nm__dumi-theme-chakra__dist__layouts__GlobalLayout__index.161c9c89.chunk.css',
              359,
            ],
            ['427.6b31bd08.async.js', 427],
            ['Button__index.md.dbe28646.async.js', 544],
            ['Input__index.md.890b0f21.async.js', 636],
            ['Tooltip__index.md.fc35d89a.async.js', 904],
            [
              'dumi__tmp-production__dumi__theme__ContextWrapper.1d4a0617.async.js',
              923,
            ],
          ...
          r: {
            '/*': [2, 3, 14, 6, 7, 11],
            '/': [12, 3, 14, 6, 7, 11],
            '/guide': [13, 3, 14, 6, 7, 11],
            '/~demos/:id': [0, 1, 4, 6, 7, 11],
            '/components/button': [8, 3, 14, 6, 7, 11],
            '/components/input': [9, 3, 14, 6, 7, 11],
            '/components/select': [5, 3, 14, 6, 7, 11],
            '/components/tooltip': [10, 3, 14, 6, 7, 11],
          },
        },
        { publicPath: '/' },
      );
